...
<div class="yzm-container-box">
	<div class="yzm-header">
		<div class="yzm-logo">
		 ...
		 <a href="<?php echo SITE_URL;?>"><img src="<?php echo STATIC_URL;?>images/yzm_logo.png" title="<?php echo $site['site_name'];?>" alt="<?php echo $site['site_name'];?>">YzmCMS内容管理系统</a>
		</div>
	...
	<div class="yzm-menu">
	  <ul class="yzm-nav">
		...
		<?php if(is_array($data)) foreach($data as $v) { ?>
		    <li>
				<a <?php if(isset($catid) && in_array($catid, explode(',', $v['arrchildid']))) { ?> class="current" <?php } ?> href="<?php echo $v['pclink'];?>" target="<?php echo $v['target'];?>"><?php echo $v['catname'];?></a>
